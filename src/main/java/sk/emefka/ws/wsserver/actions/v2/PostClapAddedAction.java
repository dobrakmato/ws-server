...
@Data
public class PostClapAddedAction extends Action {

    private int postId;
    private int userId;
    private int claps;

    public PostClapAddedAction(int postId, int userId, int claps) {
        this.postId = postId;
        this.userId = userId;
        this.claps = claps;
    }
    ...
    public PostClapAddedAction(ByteBuf from) {
        super(from);
    }

    public PostClapAddedAction(TypedStringTokenizer tokenizer) {
        super(tokenizer);
    }
